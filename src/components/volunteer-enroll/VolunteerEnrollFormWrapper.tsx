...
import { Center, Box, Flex, Text, Link, Button, VStack } from "@chakra-ui/react";
                ...
                <Center>
                    <VStack mt={120} mb={180}>
                        ...
                        <Text maxW={512} textAlign="center">
                            We're really excited that you want to volunteer for us. Look out for an
                            email from us shortly with more information!
                        </Text>
                        <Center>
                            <Link _hover={{ textDecoration: "none" }} _focus={{}} href="/class">
                                <Button
                                    mt={"55px"}
