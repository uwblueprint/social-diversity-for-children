            ...
            <>
                ...
                <Box>
                    <Text
                        ...
                        fontSize="22px"
                    >
                        You have not uploaded a Criminal Record Check yet!
                    </Text>
                ...
                <Box>
                    <Button
                        ...
                        width={"288px"}
                        height={"49px"}
                        color={colourTheme.colors.DarkGray}
                        bg={"#E2E8F0"}
                        px={10}
                        _active={{}}
                        fontWeight={"400"}
                ...
                <Box>
                    ...
                    >
                        I don't have a criminal record check yet, but I will
                        provide a CRC by the first day of volunteering
                    </Checkbox>
                </Box>
