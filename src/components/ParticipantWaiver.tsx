            ...
            <>
                ...
                <Box>
                    <Text pb="60px" align="left" mt="30px">
                        ...
                        Foundation's programs. I am aware that my child is
                        expected to respect both the emotional safety and
                        physical safety of other participants. Parents/Guardians
                        will be informed if their child's behaviour does not
                        reflect this standard. Any child who puts the safety of
                        other participants at risk may be asked to withdraw from
                        the activity. I agree to hold all Social Diversity for
                        Children staff, contractors, and volunteers, and the
                        activity in-charge, and any parties hosting this event,
                        including officers and directors, from any liability
                        resulting from the participation of the named
