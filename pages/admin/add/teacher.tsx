...
import { createTeacherUser } from "@utils/createUser";

/**
 * Internal page for admins to add/invite teachers via email
 */
export default function AddTeacher(): JSX.Element {
                ...
                <Box width="700px">
                    ...
                    <Center>
                        <Text fontWeight="400" fontSize="16px" mt="20px">
                            Invite a teacher to access internal platform
                        </Text>
                    </Center>
